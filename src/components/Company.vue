<template>
  <div class="all">
    ...
    <div class="indexPage">
      <div v-for="item in hospitalList" :key="item.title" class="list-item" @click="toBingHOS(item)">
...
export default {
  ...
  methods:{
    ...
    toBingHOS(item){
        this.$router.push(`/hospital?bindId=${item.id}`)
    }
  },
  created() {
    document.title = "单位选择";
